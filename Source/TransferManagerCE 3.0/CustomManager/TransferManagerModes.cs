...
namespace TransferManagerCE.CustomManager
{
    public class TransferManagerModes
    {
        ...
        public static bool IsGlobalDistanceRestrictionsSupported(CustomTransferReason.Reason material)
        {
            switch (material)
            {
                case CustomTransferReason.Reason.Worker0:
                ...
                default:
                    return BuildingRuleSets.IsLocalDistanceRestrictionsSupported(material);
            }
        }
    }
}
